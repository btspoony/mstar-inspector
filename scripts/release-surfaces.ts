 ...
 * and validate pick it up without per-script changes. `src/version.ts` is
 * wired this way (`kind: "ts-const"`).
 */
 ...
 * regenerated from {@link renderVersionTs} on bump (spec 016 §7
...
export function renderVersionTs(version: string): string {
  return `// Generated by \`release:prepare\` — do not edit (spec 016 §7 AD-1).
...
export async function writeSurfaceVersion(
  ...
  switch (surface.kind) {
    ...
    default: {
      // Exhaustiveness guard (QC folded item): a future surface kind
