 ...
 * Members entry. The language toggle is NOT a nav item — it renders from
 * `t(locale, "nav.language")` (the label of the OTHER locale: en shows
 * 中文, zh_CN shows EN) and POSTs to /dashboard/locale.
 */
